...
# Release milestones (repo-level). The Roadmap view groups by Milestone, so without these
...
ISSUES = [
    ...
    {"key": "EPIC-BOOK", "type": "Epic", "title": "Booking & reservation flow",
     ...
     "Schedule health": "At risk", "Impact level": "High", "Decision needed": "No decision",
    ...
    {"key": "EPIC-FLEET", "type": "Epic", "title": "Fleet & inventory management",
     ...
     "Schedule health": "On track", "Impact level": "Medium", "Decision needed": "No decision",
    ...
    {"key": "BOOK-SEARCH", "parent": "EPIC-BOOK", "type": "Feature",
     ...
     "Schedule health": "On track", "Impact level": "High", "Decision needed": "No decision",
     "Blast radius": "Blocks many", "Blast count": 2, "Blocked": "Unblocked"},
    {"key": "BOOK-CHECKOUT", "parent": "EPIC-BOOK", "type": "Feature",
     ...
     "Spec": "https://specs.example/checkout", "Blocked": "Blocked"},
    {"key": "BOOK-CONFIRM", "parent": "EPIC-BOOK", "type": "Feature",
     ...
     "Schedule health": "Blocked", "Impact level": "Medium", "Decision needed": "No decision",
     "Blast radius": "Blocks none", "Blast count": 0, "Blocked": "Blocked"},
    ...
    {"key": "FLEET-PRICING", "parent": "EPIC-FLEET", "type": "Feature",
     ...
     "Schedule health": "Blocked", "Impact level": "High", "Decision needed": "No decision",
     "Blast radius": "Blocks none", "Blast count": 0, "Spec": "https://specs.example/pricing",
     "Blocked": "Blocked"},
    {"key": "FLEET-IMG", "parent": "EPIC-FLEET", "type": "Feature",
     ...
     "Schedule health": "Blocked", "Impact level": "Low", "Decision needed": "No decision",
     "Blast radius": "Blocks none", "Blast count": 0, "Blocked": "Blocked"},
    ...
    {"key": "FEAT-AUTH", "type": "Feature", "title": "Guest account & login (OAuth)",
     ...
     "Schedule health": "Done", "Impact level": "High", "Decision needed": "No decision",
     "Blast radius": "Blocks none", "Blast count": 0, "Blocked": "Unblocked"},
    {"key": "FEAT-MAP", "type": "Feature", "title": "Pickup location map (Mapbox)",
     ...
     "Schedule health": "On track", "Impact level": "Low", "Decision needed": "No decision",
     "Blast radius": "Blocks none", "Blast count": 0, "Blocked": "Unblocked"},
    ...
    {"key": "BUG-PAYMENT", "type": "Bug", "title": "Double-charge on payment retry",
     ...
     "Blast radius": "Blocks 1", "Blast count": 1, "Blocked": "Unblocked"},
    ...
    {"key": "INFRA-CI", "type": "Infra", "title": "Set up CI/CD pipeline (GH Actions)",
     ...
     "Schedule health": "Done", "Impact level": "High", "Decision needed": "No decision",
     "Blast radius": "Blocks none", "Blast count": 0, "Spec": "https://specs.example/cicd",
     "Blocked": "Unblocked"},
