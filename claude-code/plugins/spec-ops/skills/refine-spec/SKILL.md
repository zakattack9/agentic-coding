...
- [ ] No text that exists *only* for history or context (the **Bloat** row above) — nothing a builder doesn't need. Decision/config/field **tables**, the AC table, and **load-bearing failure-mode rationale** stay. (`no_bloat`)
